...
namespace RevBayesCore {
    ...
    public:
        ...
        ScreenMonitor(const std::vector<DagNode *> &n, int g, bool pp=true, bool l=true, bool pr=true, bool pci=false);                                              //!< Constructor with vector of DAG node
